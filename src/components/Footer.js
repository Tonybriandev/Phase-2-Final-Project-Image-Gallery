...
const Footer = () => {
    ...
    return (
        <footer className="text-black-500 bg-gray-300 w-full px-4 py-5  mx-auto md:px-8 flex flex-col ">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                ...
                <p className="leading-relaxed mt-3.5 text-[15px]">
               Get to know your world through images!
                </p>
            </div>
                ...
                <div className="mt-6 sm:mt-0">
                    <ul className="flex items-center space-x-4">
                        ...
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                                ...
                                <svg class="svg-icon w-6 h-6 text-red-700" viewBox="0 0 20 20">
